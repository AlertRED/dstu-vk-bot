...
housings.add_item("Главный корпус", "", main_corp)
housings.add_item("Конгресс-холл", "", holl)
housings.add_item("Корпус №2", "", corp_2)
housings.add_item("Корпус №3,4,5", "", corp_3_4_5)
housings.add_item("Корпус №6,7", "", corp_6_7)
housings.add_item("Корпус №8", "", corp_8)

cafe_housings = Menu("Кафе")
cafe_housings.add_item("Кафе «Экспресс»", "", lambda: "Кафе «Экспресс» - 🕘 пн.-пт. | 8.30 – 17.00 |\n"
                                                      "📌 Корпус №8 (цоколь)")
cafe_housings.add_item("Кафе «Русь»", "", lambda: "Кафе «Русь» - 🕘 пн.-пт. | 8.30 – 18.00 |\n"
                                                "📌 ул. Текучева 145")
cafe_housings.add_item("Кафе «Миг»", "", lambda: "Кафе «Миг» - 🕘 пн.-пт. | 8.30 – 17.00 |\n"
                                                "📌 Главный корпус (2-й этаж)")
cafe_housings.add_item("Кафе «Миг»", "", lambda: "Кафе «Миг» - 🕘 пн.-пт. | 8.30 – 17.00 |\n"
                                                "📌 Главный корпус (2-й этаж) (карта)")
cafe_housings.add_item("Кафе «Кафедра»", "", lambda: "Кафе «Кафедра» - 🕘 пн.-пт. | 8.30 – 17.00 |\n"
                                                "📌 Корпус №7 (1-й этаж) (карта)")

hostels = Menu("Общажития")
hostels.add_item("Общежитие №1", "", lambda: "Общежитие №1 - 👤Дарсания Лемин Бичикоевич\n"
                                                "📌 ул. Студенческая 2 \n"
                                                "📞 (863) 211-10-41, 252-15-78")
hostels.add_item("Общежитие №2", "", lambda: "Общежитие №2 - 👤Тугуши Давид Александрович\n"
                                                "📌 пр. М. Нагибина 5 \n"
                                                "📞 (863) 273-84-18, 232-78-93")
hostels.add_item("Общежитие №3", "", lambda: "Общежитие №3 - 👤Исраилов Султан Адамович\n"
                                                "📌 ул. Мечникова 79а \n"
                                                "📞 (863) 273-84-19, 273-87-06")
hostels.add_item("Общежитие №4", "", lambda: "Общежитие №4 - 👤Газиев Руслан Яхьяевич\n"
                                                "📌 ул. Текучева 145\n"
                                                "📞 (863) 273-87-10, 273-87-10")
hostels.add_item("Общежитие №5", "", lambda: "Общежитие №5 - 👤Тугуши Давид Александрович\n"
                                                "📌 пр. М. Нагибина 5\n"
                                                "📞 (863) 211-10-41, 252-15-78")

sport_housings = Menu("Спортивные комплекы")
sport_housings.add_item("Легкоатлетический манеж", "", lambda: "Легкоатлетический манеж")
sport_housings.add_item("Мини-футбольное поле", "", lambda: "Мини-футбольное поле")
sport_housings.add_item("Футбольное поле", "", lambda: "Футбольное поле")
sport_housings.add_item("Бассейн", "", lambda: "Бассейн")

other = Menu("Другое")
other.add_item("Храм св. мученицы Татианы", "", lambda: "Храм св. мученицы Татианы")
other.add_item("Коворкинг «Gараж»", "", lambda: "Легкоатлетический манеж")
other.add_item("Скейт-парк", "", lambda: "Скейт-парк")

main_housing.add_menu(housings.name, housings, True, "Назад")
main_housing.add_menu(cafe_housings.name, cafe_housings, True, "Назад")
main_housing.add_menu(hostels.name, hostels, True, "Назад")
main_housing.add_menu(sport_housings.name, sport_housings, True, "Назад")
main_housing.add_menu(other.name, other, True, "Назад")

root.add_menu(main_housing.name, main_housing, True, "Назад")
root.add_menu(asa_housing.name, asa_housing, True, "Назад")
