...
class MenuTree:
    ...
    def __init__(self, placeDAO: placeDAO, grantDAO: grantDAO):
        ...
        self.grants_bak.add_basic_item('Академ. стипендия', "", self.get_grant_bak_academ)
        self.grants_bak.add_basic_item('Повышенная академ. стипендия', "", self.get_grant_bak_up_academ)
